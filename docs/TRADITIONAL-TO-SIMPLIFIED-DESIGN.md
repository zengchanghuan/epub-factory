...
> 📌 **v2 方案已发布**：针对「两岸用词差异」（軟體 vs 软件、雷根 vs 里根、機車/窩心 等歧义词）的分层管线设计，见 [`docs/CROSS-STRAIT-LEXICON-DESIGN.md`](./CROSS-STRAIT-LEXICON-DESIGN.md)。本文 v1 仍为基础底座，v2 在其之上增加 L2/L3/L4。
